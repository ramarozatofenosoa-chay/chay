...
export const CATEGORIES = [
  ...
  { id: "youtube-culte", label: "Culte", icon: Youtube, tone: "from-[#FF4D2D] to-[#FF57B2]" },
  { id: "youtube-predication", label: "Prédications (YT)", icon: Youtube, tone: "from-[#FF4D2D] to-[#8A56E2]" },
